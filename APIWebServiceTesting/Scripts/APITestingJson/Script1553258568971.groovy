...
response1 = WS.sendRequest(findTestObject('ListUsers'))
...
println('... Globalvariable Now This  :' + GlobalVariable.userName)

WS.sendRequestAndVerify(findTestObject('UpdateUsers'))
